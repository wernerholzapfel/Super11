    ...
    ['$anchorScroll', '$location', '$scope', "getRegistrationForm", "registrationService", "teamListService", "eredivisiePlayersApi", "saveteamservice",
        function ($anchorScroll, $location, $scope, getRegistrationForm, registrationService, teamListService, eredivisiePlayersApi, saveteamservice) {
            ...
            getRegistrationForm.async().then(function (data) {
                $scope.data = data;
                $scope.data.Formation = ($scope.data.Formation) ? $scope.data.Formation : "433";
                $scope.selectedFormation = ($scope.data.Formation) ? $scope.data.Formation : "433";
            ...
            $scope.playerPositions = [{Id: 1, Position: "K", PositionUi: "Keeper"}, {
                Id: 2,
                Position: "V",
                PositionUi: "Verdediger"
            }, {Id: 3, Position: "M", PositionUi: "Middenvelder"}, {Id: 4, Position: "A", PositionUi: "Aanvaller"}];
            ...
            $scope.save = function () {
                ...
                $scope.alerts.push({
                    type: 'warning',
                    msg: "Bezig met opslaan van de voorspellingen van " + $scope.data.Participant.Name
                });
