    ...
    $stateProvider
        ...
        .state('scoreform', {
            ...
            resolve: {
               ...
               // scoreform
        .state('questionsscoreform', {
            url: "/questionsscoreform.html",
            templateUrl: "views/questionsscoreform.html",
            data: {
                pageTitle: 'Vragen formulier'
            },
                ...
                deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'js/controllers/QuestionsScoreFormApiController.js'
                        ]
                    });
                }]
            }
