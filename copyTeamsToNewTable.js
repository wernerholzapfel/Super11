...
//                 Teampredictions.findOneAndUpdate({'Participant.Email': updatedteamprediction.Participant.Email, RoundId: 0 }, updatedteamprediction, ({ upsert: true }), function (err, newPrediction) {
//                     if (err) {
