    ...
    newteamStand.aggregate([
        ...
        {$unwind: "$TeamScores"},
        {
            $group: {
                ...
                SecondYellowCard: {$sum: "$TeamScores.SecondYellowCard"},
                ...
                PenaltyStoppedScore: {$sum: "$TeamScores.PenaltyStoppedScore"},
                PenaltyMissed: {$sum: "$TeamScores.PenaltyMissed"},
            ...
            $group: {
                ...
                TeamScores: {
                    $push: {
                        ...
                        PenaltyStoppedScore: "$PenaltyStoppedScore",
